...
const Home = () => {
  const { tasks = [], subjects = [], exams = [], profile = null } = useOutletContext();
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-1">
              <h1 className="text-3xl md:text-5xl font-black tracking-tight text-white">
                {greeting}, <span className="text-teal-200">{studentName}.</span>
              </h1>
        ...
        <div className="lg:col-span-7 bg-white rounded-[2.5rem] border border-slate-100 p-8 shadow-sm">
          <div className="flex justify-between items-center mb-8">
            <h3 className="text-lg font-black text-slate-800 tracking-tight flex items-center gap-2">
              Upcoming Deadlines <ArrowUpRight size={16} className="text-teal-500" />
            </h3>
            <button
            ...
            >
              <div className="relative z-10">
                <div className="flex items-center gap-2 mb-4">
                  <AlertCircle size={18} className="text-rose-100 animate-pulse" />
                  <h3 className="text-[10px] font-black uppercase tracking-[0.2em]">
                    Urgent Assessment
                  </h3>
                </div>

                <h2 className="text-2xl font-black tracking-tight mb-1">{urgentExam.subject}</h2>
          ...
          <div className="bg-white rounded-[2.5rem] border border-slate-100 p-8 shadow-sm">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-end">
                ...
                <span className="text-teal-600 font-black text-xl leading-none">{progress}%</span>
              </div>
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-4 p-4 bg-teal-50 border border-teal-100 rounded-2xl">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-teal-700 font-bold italic">
                    Review your pending tasks today.
                  </p>
                </div>
              </div>
            </div>
